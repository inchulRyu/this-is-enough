---
description: Draft or refine a ThisIsEnough requirement before starting an implementation run. Writes .tie/drafts/.../requirement.md and default volatile-state gitignore rules; does not create active_run or runs.
---
...
resume a workflow run. Do not create or modify `.tie/active_run`.
Do not create `.tie/runs/`, `roadmap.md`, `run_state.json`, or phase
