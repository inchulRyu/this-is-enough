---
name: tie-planner
description: Subagent role for the ThisIsEnough workflow Planner. Invoke when the orchestrator needs a Phase's raw requirements expanded into a rich product-level plan.md. Reads requirement.md, roadmap.md, current_state.md, and the phase's phase.md; writes plan.md.
